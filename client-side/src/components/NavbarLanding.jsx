                        ...
                        <form className="d-flex">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                <li className="nav-item-create-account">
                                    <a onClick={navigateToRegister} className="nav-link active" aria-current="page">Create An Account</a>
                                </li>
                                <li className="nav-item-sign-in">
                                    <a onClick={navigateToLogin} className="nav-link active" aria-current="page">Sign In</a>
                                </li>
                            </ul>
                        </form>    
                    </div>
